...
var (
	...
	logCollectorFilePath = "tools/logcollector/logCollector.go"
...
func deployCustomApp() {
	...
	injectorPod := common.CreatePod(backupNamespace, internal.VolumeDeviceName, container, corev1.RestartPolicyOnFailure, pvc)
